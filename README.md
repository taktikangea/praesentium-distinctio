...
![CI](https://github.com/taktikangea/praesentium-distinctio/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@taktikangea/praesentium-distinctio.svg?style=flat)](https://www.npmjs.com/package/@taktikangea/praesentium-distinctio)
...
const inject = require('@taktikangea/praesentium-distinctio')
...
```typescript
import * as LightMyRequest from '@taktikangea/praesentium-distinctio'
...
// or
import { inject, DispatchFunc } from '@taktikangea/praesentium-distinctio'
...
- `inject` - standard @taktikangea/praesentium-distinctio `inject` method
- `DispatchFunc` - the fake HTTP dispatch function
- `InjectPayload` - a union type for valid payload types
- `isInjection` - standard @taktikangea/praesentium-distinctio `isInjection` method
- `InjectOptions` - options object for `inject` method
- `Request` - custom @taktikangea/praesentium-distinctio `request` object interface. Extends
...
- `Response` - custom @taktikangea/praesentium-distinctio `response` object interface. Extends Node.js `http.ServerResponse` type
...
- Beware when using the `Request` option. That might make _@taktikangea/praesentium-distinctio_
...
Checks if given object `obj` is a *@taktikangea/praesentium-distinctio* `Request` object.
...
All the credits before the commit [00a2a82](https://github.com/taktikangea/praesentium-distinctio/commit/00a2a82eb773b765003b6085788cc3564cd08326) goes to the `hapi/shot` project [contributors](https://github.com/hapijs/shot/graphs/contributors).
Since the commit [db8bced](https://github.com/taktikangea/praesentium-distinctio/commit/db8bced10b4367731688c8738621d42f39680efc) the project will be maintained by the Fastify team.
